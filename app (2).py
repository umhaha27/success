...
# MODIFIED: Removed unused ML and plotting libraries
from sklearn.preprocessing import LabelEncoder
from sklearn.ensemble import RandomForestClassifier

# =============================================
# MODIFIED: FUNCTION TO GET TOP FEATURES
# =============================================
@st.cache_resource
def get_top_features(uploaded_file):
    ...
    # We still use RF, but *only* to suggest the Top 5 features.
    # The user will provide the weights.
    try:
...
# MODIFIED: Simplified function call
...
with col1:
    ...
    st.markdown("*(On a scale of 0-10, how strong is this feature for the deal?)*")
...
with col2:
    ...
    st.markdown("*(On a scale of 0-1, how important is this feature to you?)*")
    for feature in features:
...
# =============================================
# NEW: REAL-TIME PREDICTION & ANALYSIS
# =============================================
st.markdown("---")
...
st.dataframe(
    analysis_df.style.format({
        ...
        "Normalized Weight": "{:.1%}", # Format as percentage
...
# =============================================
# NEW: DYNAMIC & UNIQUE EXPLANATION
# =============================================
...
if final_probability > 0:
    ...
    weakest_contrib = analysis_F.iloc[-1]["Final Contribution (to Score)"]
